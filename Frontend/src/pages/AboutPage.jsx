...
function AboutPage() {
    return (
        <div className="min-h-screen w-full bg-bg text-tcolor">
            ...
            {/* 소개 페이지 전체 컨테이너 */}
            <main className="flex w-full flex-col items-center px-6 py-10">

                {/* 소개 Hero */}
                <section className="flex w-full max-w-[1080px] flex-col items-center rounded-2xl border border-gray-200 bg-white px-2 py-8 text-center shadow-sm">
                ...
                {/* FundChain의 방향 */}
                <section className="mt-6 flex w-full max-w-[1080px] flex-col items-center rounded-2xl bg-white px-3 py-5 text-center">
